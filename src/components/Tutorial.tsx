...
const TUTORIAL_PAGES: TutorialPage[] = [
  ...
  },
  {
    ...
    steps: [
      {
        title: '内阁',
        content: '右侧"内阁"图标下有内阁名单与内阁聊天。部长每月贡献指标加成（受忠诚度缩放，在月度结算时生效）。每 75 天部长会主动私信，附带选项需回应。低忠诚度部长可能背叛。',
  ...
  },
  {
    ...
    steps: [
      ...
      {
        title: '月度归因报告与历史曲线',
        content: '每月结算后可在右侧"资讯"图标的"归因"子页面查看本月归因报告：每条指标变化来自哪个决策/事件/改革/法律/内阁加成/执政疲劳，让你看清"变化来源"。归因报告保留最近 12 个月，指标历史曲线保留最近 60 个月，可回溯长期趋势。',
  ...
  },
  {
    ...
    steps: [
      ...
      {
        title: '存档系统',
        content: '游戏按设定周期（默认 15 分钟，可在设置中调整）自动存档，自动档最多保留 5 个滚动覆盖。按 ESC 打开菜单可随时快速存档与手动存档，手动档不会被自动清理。月度结算与重新开局均不会删除任何存档，可放心存取。',
        action: '养成关键决策前手动存档的习惯',
      },
      {
        title: '教程完成',
